...
export default function Education() {
  ...
  return (
    <div className="min-h-screen  flex-col bg-white items-center p-32 pl-[14%]">
        ...
        {user.length === 0 ? (
          ...
          <div className="flex">
            <div className="rounded w-[100%] mt-[10px] border-b border-gray-200 bg-gray-400 px-4 py-5 sm:px-6 ">
              <h3 className="font-bold text-black">University</h3>
              {user.map((univ: any) => {
                return (
                  <h3 className="text-left text-black mt-2">
                    {univ.university}
                  </h3>
                );
              })}
